...
Original file is located at
    https://colab.research.google.com/drive/156lzEvI2_bAetAWZ1za60Eh2EQi3-lgN
"""
...
data_file = "/content/grocery_sustainability.csv"
loader = CSVLoader(file_path=data_file.concat("/content/sustainability_data.csv")
                   , encoding='utf-8')
data = loader.load()
